...
CREATE TABLE Operateur (
    id SERIAL PRIMARY KEY,
    operateur VARCHAR(10) NOT NULL UNIQUE  
);
...
INSERT INTO Matiere (nom, coeff) VALUES ('Python', 1);

-- Étudiants
INSERT INTO Etudiant (nom) VALUES ('candidat3');
...
(3, 14.5, 1, 1),  -- candidat1
(3, 13.0, 2, 1);  -- note 10 et 11 → différence = 1
...
-- ============================================
INSERT INTO Note (id_matiere, note, id_correcteur, id_etudiant) VALUES 
(3, 12.0, 1, 1),  -- candidat1
(3, 15.0, 2, 1);  -- note 12 et 15 → différence = 3
