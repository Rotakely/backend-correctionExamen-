...
import com.entity.Parametre;  // ← AJOUT (nécessaire pour la fonction calculerNoteFinale)
...
import com.repository.ParametreRepository;  // ← AJOUT (nécessaire pour la fonction calculerNoteFinale)
...
public class NoteService {
    ...
    public BigDecimal calculerNoteFinale(Integer etudiantId, Integer matiereId) {
        ...
        for (Parametre p : parametres) {
            ...
            if (verifierCondition(sommeDifferences, diff, operateur)) {
